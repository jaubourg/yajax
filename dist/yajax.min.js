...
*/
(function(j){function i(a){var b,d,c;d=k.call(a);if(d==="[object String]")a='"'+a.replace(n,'\\"')+'"';else if(d==="[object Array]"){c=[];b=0;for(d=a.length;b<d;b++)c.push(i(a[b]));a="["+c.join(",")+"]"}else if(d==="[object Object]"){c=[];for(b in a)c.push(i(b)+":"+i(a[b]));a="{"+c.join(",")+"}"}return a}function o(a){var b=[],d=j.createElement("script"),c,f,e,g;c=0;for(f=a.length;c<f;c++){e=a[c];g={url:e.url};if(e.headers)g.headers=e.headers;if(e.type&&!/^GET$/i.test(e.type))g.type=e.type.toUpperCase();
